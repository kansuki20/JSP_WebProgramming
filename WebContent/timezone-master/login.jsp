                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                ...
                                <form class="row contact_form" action="LoginPro.jsp" method="post" novalidate="novalidate">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <button type = "button" onclick="location.href = 'signup.jsp'" class="btn_3">Sign Up</button>
